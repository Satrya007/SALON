<div class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <a data-toggle="modal" data-target="#add" href="#" class=" btn btn-sm btn-info shadow-sm"><i
  ...
  <div class="card shadow mb-4">
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-ainfo">Data Service</h6>
    </div>
    <div class="card-body">
          ...
          <tbody>
            ...
            foreach ($dt_service as $d): ?>
              ...
              <tr>
                ...
                <td>Rp <?= number_format($d->biaya, 0, ',', '.'); ?></td> <!-- Updated biaya with Rp prefix -->
                <td><?= $d->durasi; ?></td>
                <td><a href="<?= base_url(); ?>upload/<?= $d->file; ?>"><img width="50px"
                      src="<?= base_url(); ?>upload/<?= $d->file; ?>"></a></td>
                <td>
                  <div align="center">
                    <a class="btn btn-sm btn-danger shadow-sm" data-tooltip="tooltip" data-bs-placement="top"
                      ...
                      href="<?= base_url('admin/delete_service/' . $d->id_service); ?>"><i
                        class="fas fa-trash fa-sm"></i></a>
                    <a class="btn btn-sm btn-info shadow-sm" data-tooltip="tooltip" data-bs-placement="top" title="Edit"
                      href="#" data-toggle="modal" data-target="#modaledit<?= $d->id_service ?>"><i
          ...
          <div class="mb-3">
            ...
            <select class="form-control" name="id_kategori">
              ...
              <?php foreach ($dt_kategori as $r): ?>
                <option value="<?= $r->id_kategori; ?>" <?php if ($r->id_kategori == $f->id_kategori) {
                    echo 'selected';
                  } ?>>
                  <?= $r->nama_kategori; ?>
                </option>
