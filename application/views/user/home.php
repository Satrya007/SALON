...
<!-- End price Area -->
<div class="modal fade" id="testimoni" tabindex="-1" role="dialog" aria-labelledby="exampleModalFormTitle"
	aria-hidden="true">
		...
		<div class="row d-flex justify-content-center">
			<div class="menu-content pb-70 col-lg-8">
				<div class="title text-center">
					...
					<a data-toggle="modal" data-target="#testimoni" href="#" class="primary-btn text-uppercase">Kirim
						Testimoni Anda</a>
				</div>
			</div>
		</div>
			...
			<div class="col-lg-4 d-flex flex-column address-wrap">
				<div class="single-contact-address d-flex flex-row">
					...
					<div class="contact-details">
						<h5>
						Khusus Kota Surabaya, dan Sidoarjo. JAWA TIMUR</h5>
						<p>
